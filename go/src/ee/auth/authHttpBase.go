...
func NewAccountHttpQueryHandlerFull(queryRepository *AccountQueryRepository) (ret *AccountHttpQueryHandler) {
...
func NewAccountHttpCommandHandlerFull(context context.Context, commandBus eventhorizon.CommandHandler) (ret *AccountHttpCommandHandler) {
...
func NewAccountRouter(pathPrefix string, context context.Context, commandBus eventhorizon.CommandHandler, 
    ...
    queryHandler := NewAccountHttpQueryHandlerFull(queryRepository)
    commandHandler := NewAccountHttpCommandHandlerFull(context, commandBus)
    ret = &AccountRouter{
