...
func (o *AccountAggregateInitializer) RegisterForSentEnabledConfirmation(handler eventhorizon.EventHandler) error {
	return o.RegisterForEvent(handler, AccountEventTypes().AccountSentEnabledConfirmation())
}

func (o *AccountAggregateInitializer) RegisterForSentDisabledConfirmation(handler eventhorizon.EventHandler) error {
	return o.RegisterForEvent(handler, AccountEventTypes().AccountSentDisabledConfirmation())
}

func (o *AccountAggregateInitializer) RegisterForLogged(handler eventhorizon.EventHandler) error {
	return o.RegisterForEvent(handler, AccountEventTypes().AccountLogged())
}

func (o *AccountAggregateInitializer) RegisterForSentCreatedConfirmation(handler eventhorizon.EventHandler) error {
